...
public class FENKPSPublicSoap
{
    ...
    public FENKPSPublicSoap(){}

    public FENKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FENKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FENExtendedSoapSerializationEnvelope envelope= new FENExtendedSoapSerializationEnvelope(FENExtendedSoapSerializationEnvelope.VER11);
