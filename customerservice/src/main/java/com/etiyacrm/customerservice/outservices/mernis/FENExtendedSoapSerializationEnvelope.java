...
class FENSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class FENExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FENDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new FENStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FENDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FENDateTimeConverter dateTimeConverter = new FENStandardDateTimeConverter();

    public FENExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FENExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FENMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FENHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FENExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FENHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
